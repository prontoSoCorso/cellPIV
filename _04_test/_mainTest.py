...
def main(base_path = os.path.join(current_dir, "final_test_images_and_metrics"), days=[1, 3, 5, 7], models = ['ROCKET', 'LSTMFCN', 'ConvTran'], base_models_path=current_dir, base_test_csv_path=parent_dir):
