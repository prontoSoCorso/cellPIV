...
def main_LSTM():
    ...
    best_model_path = os.path.join(parent_dir, conf.test_dir, "lstm_model_best.pkl")
    best_model = joblib.load(best_model_path)
    test_metrics = evaluate_model(best_model, X, y)
...
def main_LSTMFCN():
    ...
    best_model_path = os.path.join(parent_dir, conf.test_dir, "lstmfcn_model_best.pkl")
    best_model = joblib.load(best_model_path)
    test_metrics = evaluate_model(best_model, X, y)
...
def main_ConvTran():
    ...
    best_model_path = os.path.join(parent_dir, conf.test_dir, "convtran_model_best.pkl")
    best_model = joblib.load(best_model_path)
    test_metrics = evaluate_model(best_model, X, y)
    ...
    save_confusion_matrix(test_metrics[5], "confusion_matrix_convtran.png")
