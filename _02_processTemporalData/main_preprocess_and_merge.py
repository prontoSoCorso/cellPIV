...
def main():
    ...
    for pickle_name, obj in pickle_data.items():
        ...
        to_save_full = {k: v['resampled_values'] for k, v in processed_dict.items()}
        ...
        to_save_filtered = {k: processed_dict[k]['resampled_values'] for k in matched_keys}
    ...
    for _, meta_row in csv_data.iterrows():
        ...
        if matched_key is None:
            ...
            series_vals = proc_for_csv[matched_key]['resampled_values']
