...
def prepare_image(seq_dir):
    ...
    for fn in image_list:
        ...
        print("11111111111111111111111111111111111111111111111 - img shape")
        print(img)
...
def MOF_inference(model, cfg):
    ...
    print("22222222222222222222222222222222222222222 - input_images shape")
    print(input_images.shape)

    print("33333333333333333333333333333333333333333 - model")
    print(model)
