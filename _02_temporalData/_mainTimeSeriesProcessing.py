...
def main(path_pkl = os.path.join(current_dir,conf.path_pkl),
         temporal_csv_path = conf.temporal_csv_path,
         original_csv_path = conf.csv_file_Danilo_path, 
         final_csv_path = conf.final_csv_path,
         path_output_dim_reduction_files=os.path.join(current_dir, "dim_reduction_files"),
...
if __name__ == '__main__':
    ...
    main(path_pkl = os.path.join(current_dir,conf.path_pkl),
         temporal_csv_path = conf.temporal_csv_path,
         original_csv_path = conf.csv_file_Danilo_path, 
         final_csv_path = conf.final_csv_path,
         path_output_dim_reduction_files=os.path.join(current_dir, "dim_reduction_files"),
